...
ifeq ($(TARGET_ARCH),arm)
    ifneq ($(wildcard $(PWD)/prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-linux-androideabi-4.7/bin),)
        # this should be copied to HOST_OUT_EXECUTABLES instead
        ABP:=$(ABP):$(PWD)/prebuilts/gcc/$(HOST_PREBUILT_TAG)/arm/arm-linux-androideabi-4.7/bin
    endif
...
$(info   GOOGLE_47_BUILD=$(GOOGLE_47_BUILD))
$(info   LINARO_47_BUILD=$(LINARO_47_BUILD))
$(info   USE_LINARO_COMPILER_FLAGS=$(USE_LINARO_COMPILER_FLAGS))
$(info   DEBUG_NO_STRICT_ALIASING=$(DEBUG_NO_STRICT_ALIASING))
$(info   DEBUG_NO_STDCXX11=$(DEBUG_NO_STDCXX11))
$(info   USE_NEW_MEMCPY=$(USE_NEW_MEMCPY))
$(info   TARGET_INCLUDE_EXTRA_CFLAGS=$(TARGET_INCLUDE_EXTRA_CFLAGS))
$(info ============================================)
endif
